...
const Header: React.FC = () => {
	return (
		<>
			<header
				style={{
					backgroundImage: "url(../../public/photos/two-people-hiking.jpg)",
				...
				className="h-[600px] w-full object-cover -z-10 flex items-center justify-center flex-col text-white relative"
			>
				<h1
				...
				<p>Join out events</p>
				<div className="arrows bottom-0 absolute">
					<SlArrowUp size={60} />
				</div>
			</header>
			...
			<div className="navbar bg-opacity-50 bg-base-300 z-50 fixed top-0">
